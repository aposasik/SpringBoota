...
public class DeigmaOrnithopanida {
    ...
    public DeigmaOrnithopanida(Long id, String researcher, String locality, LocalDate date, LocalTime time,
            String kodikosDeigmatolipsias, String xrimatodotikoMeso, String habitat, Double xegsa, Double yegsa,
            Double latitude, Double longitude, Double altitude, Double xegsat, Double yegsat, Double latitudet,
            Double longitudet, Double altitudet, String paratiriseis, String gridCell, String nomos, String methodos,
            ...
            String kateuthinsiAnemouAzim, String thermokrasia, String entasiAnemou) {
        this.id = id;
    ...
    public DeigmaOrnithopanida(Deigmata deigmata,
            Set<DeigmaOrnithopanidaXPresAndThreats> deigmaOrnithopanidaXPresAndThreatsSet,
            Set<DeigmaOrnithopanidaXSpecies> deigmaOrnithopanidaXSpeciesSet, String researcher, String locality,
            LocalDate date, LocalTime time, String kodikosDeigmatolipsias, String xrimatodotikoMeso, String habitat,
            Double xegsa, Double yegsa, Double latitude, Double longitude, Double altitude, Double xegsat,
            Double yegsat, Double latitudet, Double longitudet, Double altitudet, String paratiriseis, String gridCell,
            String nomos, String methodos, String kodikosNatura, String kyriarxosTyposVlastisis, String kalypsi,
            String ypsosVlastisis, String poiotita, String puknotita, Byte file, Byte photo, String nefoseis,
            String kateuthinsiAnemou, String kateuthinsiAnemouAzim, String thermokrasia, String entasiAnemou) {
